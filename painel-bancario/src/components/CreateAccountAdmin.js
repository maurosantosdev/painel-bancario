        ...
        <div className='bg-gray-800 flex flex-col justify-center'>
          ...
          {!accessToken ? (
            <div className='max-w-[400px] w-full mx-auto rounded-lg bg-gray-900 p-8 px-8'>
                <h2 className='text-4xl dark:text-white font-bold text-center'>Painel Bancário</h2>
                <br></br>
              ...
              <div className='text-4xl dark:text-white font-bold text-center'>
                <div className="form-container">
                  <h2 className='text-3xl dark:text-white font-bold text-center'>Criar Nova Conta</h2>
                  <br></br>
                  <select
                    value={accountType}
                ...
                <button className='text-inputs tamanho-inputs w-full my-5 py-2 bg-teal-500 shadow-lg shadow-teal-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg' onClick={handleCreateAccount}>
                  Criar Conta
                </button>
